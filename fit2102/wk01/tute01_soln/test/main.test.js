...
const usesForLoop = fn => {
    const src = fn.toString();
    return /\bfor\s*\(/.test(src); // detects "for (...)"
};
...
describe("exercise_5_suite", function () {
    describe("Function `multiplyArray`", function () {
        ...
        it("uses array methods and not for loop", function () {
            ...
            expect(usesForLoop(multiplyArray)).to.equal(false);
        });
    ...
    describe("Function `filterEvenNumbers`", function () {
        ...
        it("uses array methods and not for loop", function () {
            ...
            expect(usesForLoop(filterEvenNumbers)).to.equal(false);
        });
    ...
    describe("Function `findMax`", function () {
        ...
        it("uses array methods and not for loop", function () {
            ...
            expect(usesForLoop(findMax)).to.equal(false);
        });
    ...
    describe("Function `tripleAndFilterOdds`", function () {
        ...
        it("uses array methods and not for loop", function () {
            ...
            expect(usesForLoop(tripleAndFilterOdds)).to.equal(false);
        });
    ...
    describe("Function `countOddNumbers`", function () {
        ...
        it("uses array methods and not for loop", function () {
            ...
            expect(usesForLoop(countOddNumbers)).to.equal(false);
        });
